...
// Per-question AI critique state.
...
// between 1 and 1000` CHECK constraint so the form can't submit a value
...
function CreateFeedbackInner() {
  ...
  // Per-question AI critique, keyed by question id. On-demand
  ...
  // AI question generation — calls the server route,
  ...
  // On-demand AI critique of one question. Never auto-fired,
                      ...
                      >
                        ...
                        {isExpanded && (
                          <div className="px-4 pb-4 pt-3 space-y-4 border-t border-white/10">
                            ...
                            {/* AI critique result — on-demand, never auto-edits */}
                            {(() => {
